...
class Snake(models.Model):
    ...
    s_name = models.CharField(max_length = 256, verbose_name = "Nom scientifique", default='Python regius')
    c_name = models.CharField(max_length = 256, verbose_name = "Nom commun", default='Python royal')
    birthday = models.CharField(max_length = 10, verbose_name = "Né en", default='2017')
    mutation = models.ForeignKey(Mutation, on_delete = models.CASCADE)
    sex = models.CharField(max_length = 1, verbose_name = "Sexe", choices = SEX_CHOICES, default='M')
    slug = models.SlugField()
    captive_birth = models.BooleanField(verbose_name = "NZ", blank = True, default=True)
    cites = models.BooleanField(verbose_name = "Soumi au CITES", blank = True, default=True)
